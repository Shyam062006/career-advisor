...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const fetchProfile = async (userId: string) => {
    try {
      ...
      // If profiles table doesn't exist or has no data, create fallback from user metadata
  ...
  const signUp = async (email: string, password: string, firstName: string, lastName: string) => {
    ...
    if (!error && data.user) {
      ...
      try {
        ...
        if (profileError) {
          console.log('Note: profiles table may not exist yet - profile creation skipped')
        }
      } catch (e) {
        console.log('Note: profiles table may not exist yet')
      }
    }
